...
export const zh: Dict = {
  ...
  about: {
    ...
    p2: '我的课堂温暖、有条理，也足够实用——每次下课，你都能带走真正用得上的东西：一个新表达、更清晰的发音、一场真实的对话。我会用 AI 工具帮你高效完成课后练习与复习，但课堂上真正重要的——兴趣、情绪与文化故事——始终由真人来完成。',
    points: [
      '为你量身定制的学习计划',
      '耐心、鼓励式的教学风格',
      '跨时区灵活约课',
    ...
    cards: [
      {
        ...
        points: ['让孩子从“被要求学”变成“主动想学”', '用文化故事与兴趣切入（说唱、动画、祖辈故事）', 'TPR 互动教学 + 游戏化课堂'],
      },
      {
        tag: '日常流利沟通',
        title: '成人通用普通话',
      ...
      },
      {
        tag: '考试备考',
        title: 'HSK备考',
        desc: 'HSK 3.0 全等级备考（1–9 级，三等九级），听力、阅读真题训练，冲刺目标分数。',
        points: ['HSK 3.0（1–9 级）专项训练', '听力、阅读真题演练', '针对性补强薄弱项'],
      },
      {
        tag: '职场应用',
        title: '商务中文',
  ...
  pricing: {
    ...
    popular: '最受欢迎',
    cta: '开始咨询',
    note: '价格为美元计价；每节课 60 分钟，一对一在线授课。真人老师能读懂你的情绪、兴趣与节奏——这正是 AI 工具替代不了的部分，也是你选择真人私教的原因。',
    tiers: [
      {
        name: '单次体验课',
        price: '$30',
  ...
  meta: {
    ...
    description:
      '与 Lydia 一起学习普通话——少儿与青少年、成人会话、HSK 3.0 备考（1–9 级）及商务中文，一对一在线授课。立即预约免费咨询。',
  },
};
