    ...
    cards: [
      {
        tag: '6–17 岁',
        title: '少儿与青少年',
        desc: '为华裔孩子和少儿初学者设计的趣味课堂——听说、识字，加上一份对中文真正的喜爱。',
      ...
      },
      {
        tag: '考试 + 职场',
        title: 'HSK 备考与商务中文',
        desc: 'HSK 1–6 系统备考，以及会议、谈判、邮件等职场中文。',
        points: ['HSK 1–6 备考策略', '商务与职场场景演练', '进度可量化的学习'],
      },
    ],
  },
  pricing: {
    eyebrow: '课时与价格',
    title: '简单透明的价格',
    subtitle: '以下为示例价格——让我们找到最适合你的方案。',
    popular: '最受欢迎',
    cta: '开始咨询',
    note: '以上均为示例价格，预约时确认实际课时费。',
    tiers: [
      {
        name: '单次体验课',
        price: '$30',
      ...
      },
      {
        ...
        price: '$280',
        unit: '折合每节 $28 · 省 $20',
        features: ['包含单次课全部权益', '每 5 节一次进度回顾', '灵活改期'],
        popular: true,
      },
      {
        name: '20 节课程包',
